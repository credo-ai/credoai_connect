...
class Governance:
    ...
    def _api_export(self):
        ...
        assessment = self._api.create_assessment(self._use_case_id, self._prepare_export_data())
        ...
        if assessment["result"] == "success":
            ...
            global_logger.info(f"{len(evidences)} evidences were successfuly uploaded, took {duration} ms")
        else:
